...
<div class="row">
    <div class="col-lg-6">
        <form id="payment-form" class="row g-3" method="POST">
            ...
            <input type="hidden" name="kelurahan_label" id="kelurahan_label">
            <div class="col-12">
            ...
            processResults: function (data) {
                return {
                    results: data.map(function(item) {
                        return {
                            id: item.id, // ID kelurahan
                            text: item.subdistrict_name + ", " + item.district_name + ", " + item.city_name + ", " + item.province_name + ", " + item.zip_code, // Label lengkap
                            label: item.label  // Pastikan label dikirim
                        };
                    })
                };
            },
