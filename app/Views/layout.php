...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url()?>NiceAdmin/assets/img/dumbell.png" rel="icon">
...
<body>
  ...
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
    ...
    <!-- jQuery -->
      <script src="https://code.jquery.com/jquery-3.6.0.min.js" nonce="<?= esc($csp_nonce ?? '') ?>"></script>
  <!-- Select2 -->
  <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js" nonce="<?= esc($csp_nonce ?? '') ?>"></script>
